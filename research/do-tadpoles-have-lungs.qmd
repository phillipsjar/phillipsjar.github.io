...
subtitle: "Yes, and they also suck!"
...
Most tadpoles have lungs, and they start using them almost immediately.
...
But what about before then? I've now told you that while tiny tadpoles breathe air,  they are also too small to overcome surface tension.
...
We looked at breathing across development and found a statistical relationship between bubble sucking and size that translated across species. Nearly every tadpole we looked at started breaching (not bubble sucking) at around the same size (~10 mm), suggesting that size might be the driving force here.
...
Black bars are bubble-sucking breaths, purple bars are breaches. Tadpoles' first breaths are usually bubble sucks, because they are too small to do anything else. As they get bigger, around 10 mm body length, they start to breach, and then quickly are almost always breaching when they breathe. 
:::
